...
BEGIN
    ...
    BEGIN TRY
        SET @SQLQuery = '
            ...
            WHERE m.Ano = ''2024''
			    AND (m.Conta LIKE ''2431%'' 
			         OR m.Conta LIKE ''2422%'' 
			         OR m.Conta LIKE ''2423%'' 
			         OR m.Conta LIKE ''2424%'' 
			         OR m.Conta LIKE ''2425%'' 
			         OR m.Conta LIKE ''2426%'' 
			         OR m.Conta LIKE ''2427%'' 
			         OR m.Conta LIKE ''2428%'' 
			         OR m.Conta LIKE ''2429%'')
			  AND m.Mes >= 1
			  AND m.Mes <= 13
            GROUP BY m.Conta;';
